...
ps.executeUpdate();
PreparedStatement ps1=con.prepareStatement("update cart set address=?, city=?, state=?, country=?, mobileNumber=?,payment=?,transactionId=?,status=? where email=? and address is NULL");
//orderDate=now(),deliveryDate=DATE_ADD(orderDate,INTERVA 7 DAY)
